    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="bg-gray-50 p-4 rounded-lg border">
          <h4 className="font-medium text-nutrition-primary mb-2">Service Details</h4>
        ...
        <div className="bg-gray-50 p-4 rounded-lg border">
          <h4 className="font-medium text-nutrition-primary mb-2">Personal Details</h4>
          <div className="grid grid-cols-2 gap-y-2 text-sm">
        ...
        <div className="bg-gray-50 p-4 rounded-lg border">
          <h4 className="font-medium text-nutrition-primary mb-2">Appointment Purpose</h4>
          <p className="text-sm">{userInfo.purpose}</p>
        </div>

        {userInfo.additionalServices.length > 0 && (
          <div className="bg-gray-50 p-4 rounded-lg border">
            <h4 className="font-medium text-nutrition-primary mb-2">Additional Services</h4>
